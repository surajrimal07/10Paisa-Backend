...
// const iv = Buffer.alloc(16); //always generate same iv
...
//     //    const encryptedHex = Buffer.concat([iv, encryptedData]).toString('hex');
//     return iv.toString('hex') + ':' + encryptedData.toString('hex');
// }

// export async function decryptData(encryptedText) {
//     const [iv, encryptedData] = encryptedText.split(':').map(part => Buffer.from(part, 'hex'));
//     const decipher = crypto.createDecipheriv(algorithm, key, iv);
//     const decryptedData = Buffer.concat([decipher.update(encryptedData), decipher.final()]);
//     return decryptedData.toString('utf8');
// }

// // console.log(encryptData('12345'));
...
//     const decryptedData = await decryptData('20a36824985b4c1fb1d84db4040e126c:9e4622722f90c66bc8cd1eb9');
...
// // console.log(decryptData("10a3ea4b31b7a82d30bce220dcdffa1e:eb3923fdf8"));
