...
//         //also add name to the stock, and ltp, add these two field in stocks values
...
//         const totalValue = this.stocks.reduce((total, stock) => total + stock.currentprice, 0);
//         const totalPortgainloss = this.stocks.reduce((total, stock) => total + stock.netgainloss, 0);

//         // Update gainLossRecords with the calculated values
//         this.gainLossRecords = [{
//             date: new Date(),
//             value: totalValue,
//             portgainloss: totalPortgainloss,
//         }];

//         next();
//     } catch (error) {
//         console.error('Error updating stock prices and gainLossRecords:', error.message);
//         next(error);
//     }
// });
