...
const host =
  isPrimary && redisLocalhost
    ? process.env.REDIS_HOST_PROD_LOCAL
    : process.env.REDIS_HOST_PROD;
const port =
  isPrimary && redisLocalhost
    ? process.env.REDIS_PORT_PROD_LOCAL
    : process.env.REDIS_PORT_PROD;
const password =
  isPrimary && redisLocalhost
    ? process.env.REDIS_PASSWORD_PROD_LOCAL
    : process.env.REDIS_PASSWORD_PROD;
const timeout = parseInt(process.env.REDIS_PROD_TIMEOUT);
