    ...
    try {
        ...
        rows.forEach((row) => {
            ...
            const stockInfo = {
                ...
                open: parseInt(columns[3].textContent.replaceAll(',', '')),
                high: parseInt(columns[4].textContent.replaceAll(',', '')),
                low: parseInt(columns[5].textContent.replaceAll(',', '')),
                ltp: parseInt(columns[6].textContent.replaceAll(',', '')),
                vwap: parseInt(columns[7].textContent.replaceAll(',', '')),
                volume: parseInt(columns[8].textContent.replaceAll(',', '')),
                previousclose: parseInt(columns[9].textContent.replaceAll(',', '')),
                //Turnover: columns[10].textContent,
                Turnover: parseInt(columns[10].textContent.replaceAll(',', '')),
                //percentchange: parseInt(columns[14].textContent),
                percentchange: parseFloat(columns[14].textContent.replaceAll(',', '')),
                day120: parseInt(columns[17].textContent.replaceAll(',', '')),
                day180: parseInt(columns[18].textContent.replaceAll(',', '')),
                week52high: parseInt(columns[19].textContent.replaceAll(',', '')),
                week52low: parseInt(columns[20].textContent.replaceAll(',', '')),
